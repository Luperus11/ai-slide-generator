...
def generate_slides_from_groq(topic_or_content):
    ...
    try:
        ...
        จงนำเนื้อหาเอกสารวิชาการต่อไปนี้ มาสกัดความรู้ สรุปสูตร คำนวณ แนวคิดหลัก และจัดทำเป็นสไลด์การสอนจำนวน 5 ถึง 6 สไลด์เต็ม:
        ...
        4. narration ให้เขียนบทบรรยายสอนภาษาไทยแบบเป็นธรรมชาติ สรุปอธิบายสไลด์นั้นๆ อย่างกระชับ (2-3 ประโยคต่อสไลด์)

        ตอบกลับในรูปแบบ JSON วัตถุโดยมีคีย์ "slides" ที่บรรจุ Array จำนวน 5-6 สไลด์ดังนี้เท่านั้น:
        {{
          "slides": [
            {{
